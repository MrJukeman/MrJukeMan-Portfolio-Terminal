...
export const commands: Command = [
  { cmd: "about", desc: "About MrJukeman", tab: 8 },
  { cmd: "clear", desc: "Clear the terminal", tab: 8 },
  { cmd: "education", desc: "Education background", tab: 4 },
  { cmd: "email", desc: "Contact Me Through My Email", tab: 8 },
  ...
  { cmd: "whoami", desc: "Get to know who you are.", tab: 7 },
];
